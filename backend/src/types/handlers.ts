...
import {
    AuthenticatedRequest, TournamentRequest, RoundRequest, ScorerRequest, OrganizerRequest, TeamRequest,
    PairingRequest
} from './express.d';
...
export const pairingHandler      = (fn: Handler<PairingRequest>): RequestHandler => wrap(fn);
