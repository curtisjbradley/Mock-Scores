...
The creation wizard will walk the organizer through 6 steps.

## Tournament Details

The first page of the wizard will ask for:

* **Tournament Name**
* **Tournament Location**
* **Tournament Start and End Dates**
* **A toggle for sharing individual rankings**

All of these setting can be edited after creation.
If individual rankings are toggled then award nominations will be viewable by coaches.

## Case Format and Witnesses