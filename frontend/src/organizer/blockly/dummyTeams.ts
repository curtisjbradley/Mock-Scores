...
export interface Pairing {
  ...
  /** Number of scorers on this pairing. */
  num_scorers: number;
}
...
export const dummyTeams: DummyTeam[] = [
  {
    ...
    name: 'Team A', code: 'A',
    pairings: [
      { opponent: 'B', ballots: [{ pointsFor: 185, pointsAgainst: 172 }, { pointsFor: 180, pointsAgainst: 180 }], won_presider_tiebreaker: true, num_scorers: 2 },  // ballot tie in game 2
  ...
  },
  {
    ...
    name: 'Team B', code: 'B',
    pairings: [
      { opponent: 'A', ballots: [{ pointsFor: 172, pointsAgainst: 185 }, { pointsFor: 180, pointsAgainst: 180 }], won_presider_tiebreaker: false, num_scorers: 2 }, // ballot tie in game 2
      { opponent: 'C', ballots: [{ pointsFor: 178, pointsAgainst: 178 }, { pointsFor: 182, pointsAgainst: 171 }], won_presider_tiebreaker: true, num_scorers: 2 },  // ballot tie in game 1
  ...
  },
  {
    ...
    pairings: [
      ...
      { opponent: 'B', ballots: [{ pointsFor: 178, pointsAgainst: 178 }, { pointsFor: 171, pointsAgainst: 182 }], won_presider_tiebreaker: false, num_scorers: 2 }, // ballot tie in game 1
